...
jQuery(document).ready( function($) { 
	jQuery('.column-equal-heights').matchHeight(); 
	
	var rows = $.fn.matchHeight._rows($('.column-equal-heights'));

	$.each(rows, function(i, row) {
		row.first().addClass('column-first');
		row.last().addClass('column-last');
	});
	$('.column-equal-heights').on('click', function(){
		var _this = $( this );
