...
},{"jquery":19,"js-cookie":20}],2:[function(require,module,exports){
'use strict';
...
},{"jquery":19,"js-cookie":20}],3:[function(require,module,exports){
'use strict';
        ...
        if (!$this.find('button').hasClass('disabled')) {
            ...
            if (err > 0) {
                ...
                $.ajax({
                    ...
                    data: formData,
                    crossDomain: true,
                    success: function success(data, result, xhr) {
...
$(document).ready(function () {
  ...
  */
		...
		$('.slick-fold_slider').slick({
				...
				cssEase: 'linear',
				pauseOnHover: false,
				responsive: [{ breakpoint: 480, settings: { dots: false } }]
		});
		...
		$('.slick-carousel_1').slick({
				...
				arrows: false,
				dots: true,
				responsive: [{ breakpoint: 1100, settings: { slidesToShow: 3, slidesToScroll: 3 } }, { breakpoint: 700, settings: { slidesToShow: 2, slidesToScroll: 2 } }, { breakpoint: 480, settings: { slidesToShow: 1, slidesToScroll: 1 } }]
		});
		...
		if ($('.slick-carousel_2').length > 0) {
				$.each($('.slick-carousel_2'), function (e) {
						$(this).slick({
								...
								arrows: false,
								dots: true,
								responsive: [{ breakpoint: 1200, settings: { slidesToScroll: 3, slidesToShow: 3 } }, { breakpoint: 900, settings: { slidesToScroll: 2, slidesToShow: 2 } }, { breakpoint: 480, settings: { slidesToScroll: 1, slidesToShow: 1 } }]
						});
				});
		}
		...
		if ($('.slick-carousel_3').length > 0) {
				...
				$.each($('.slick-carousel_3'), function (e) {
						...
						$(this).slick({
								...
								arrows: true,
								dots: true,
								responsive: [{ breakpoint: 1400, settings: { slidesToShow: 3, slidesToScroll: 3 } }, { breakpoint: 1000, settings: { slidesToShow: 2, slidesToScroll: 2 } }, { breakpoint: 660, settings: { slidesToShow: 1, slidesToScroll: 1 } }]
						});
				});
		}
		...
		if ($('.slick-logo_scroll').length > 0) {
				$.each($('.slick-logo_scroll'), function (e) {
						...
						$(this).slick({
								...
								arrows: false,
								dots: false,
								responsive: [{ breakpoint: 1200, settings: { slidesToShow: 3 } }, { breakpoint: 800, settings: { slidesToShow: 2 } }, { breakpoint: 400, settings: { slidesToShow: 1 } }]
						});
				});
		}
...
},{"bootstrap/js/dist/tab.js":5,"imagesloaded":11,"isotope-layout":12,"jquery":19,"jquery-bridget":18,"magnific-popup":21,"onscreen":23,"sidr/dist/jquery.sidr.js":26,"slick-carousel":27}],5:[function(require,module,exports){
...
},{"./util.js":6,"jquery":19}],6:[function(require,module,exports){
(function (global, factory) {
...
},{"ev-emitter":8}],12:[function(require,module,exports){
/*!
 * Isotope v3.0.6
 *
...
},{"./item":13,"./layout-mode":14,"./layout-modes/fit-rows":15,"./layout-modes/masonry":16,"./layout-modes/vertical":17,"desandro-matches-selector":7,"fizzy-ui-utils":9,"get-size":10,"outlayer":25}],13:[function(require,module,exports){
/**
 * Isotope Item
**/
...
},{"outlayer":25}],14:[function(require,module,exports){
/**
 * Isotope LayoutMode
 */
...
},{"get-size":10,"outlayer":25}],15:[function(require,module,exports){
/**
 * fitRows layout mode
 */
...
},{"../layout-mode":14,"masonry-layout":22}],17:[function(require,module,exports){
/**
...
},{"get-size":10,"outlayer":25}],23:[function(require,module,exports){
(function (global, factory) {
...
},{"ev-emitter":8,"get-size":10}],25:[function(require,module,exports){
/*!
 * Outlayer v2.1.1
...
},{"./item":24,"ev-emitter":8,"fizzy-ui-utils":9,"get-size":10}],26:[function(require,module,exports){
