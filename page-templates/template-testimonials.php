                ...
                <div class="testimonial">
                    <div class="testimonial-img">
                        ...
                        if (has_post_thumbnail()) {
                            ...
                            <img width="120" height="120" src="https://lh5.ggpht.com/-CFYUaGYh6Y8/AAAAAAAAAAI/AAAAAAAAAAA/MWWT48ek100/s128-c0x00000000-cc-rp-mo/photo.jpg" class="attachment-sm-square size-sm-square wp-post-image" alt="<?php the_title(); ?>" />
                        <?php } ?>
                    </div>
                    <div class="testimonial-text">
                        ...
                        <?php
                        if (get_post_meta(get_the_ID(), 'meta_testimonial_video', true)) { ?>
