        ...
        <div class="columns twelve">
            <div class="main-content">
                <div class="terms-of-use-content">
                    <h3><?php site_ops_practice_name(); ?> Website Terms of Use – User Agreement</h3>
                    ...
                    <h3>Copyright</h3>
                    <p>The entire contents of <?php site_ops_practice_name(); ?>’s website including: logos, trademarks, service marks, brand names, information, materials, interfaces, computer code, databases, text, images, photographs, audio and visual material, etc as well as design, structure and assembly, are the property of [practice_name], its licensors, partners, sponsors, advertisers, content providers or other third parties and is protected by law. The reproduction, transmission, distribution, sale, publication or otherwise is prohibited without prior written consent obtained from <?php site_ops_practice_name(); ?> or the owner of the content if <?php site_ops_practice_name(); ?> is not the owner.You may not alter, delete or conceal any copyright or other notices appearing in the <?php site_ops_practice_name(); ?> content including notices appearing on materials available for download.</p>
                    <h3>Disclaimers</h3>
                    ...
                    <p>Our website may link to other websites, as other websites may link to ours. We do not review, control or take responsibility for the accuracy of content on these websites. Nor do we review, control or take responsibility for their privacy and security policies. Accessing these websites is at your own risk and <?php site_ops_practice_name(); ?> shall assume no liability for users use on any linked sites.</p>
                    <h3>Privacy</h3>
                    <p>Most information transmitted electronically is not secure, therefore, we can make no guarantees to privacy or confidentiality. <?php site_ops_practice_name(); ?> and its affiliates take extensive measures to protect sensitive information. Personal medical information should never be sent through our website. Please review our Privacy Statement for further information.</p>
                    <h3>Contact Us</h3>
                    <p>Please contact us with any questions regarding our Website Terms of Use by contacting <?php site_ops_practice_name(); ?> at <?php site_ops_current_patient_phone(); ?></p>
                    <p><?php site_ops_practice_name(); ?>, All Rights Reserved</p>
