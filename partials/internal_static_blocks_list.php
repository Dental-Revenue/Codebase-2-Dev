...
<div class="row">
  ...
  <div class="static_blocks_list-text">
    <?php if(!empty($headline)){ ?><p class="headline <?php echo $headline_style; ?>" <?php if(empty($content)){ ?>style="padding-bottom: 6px;"<?php } ?>><?php echo $headline; ?></p><?php } ?>
    <?php if ($subtitle) : ?>
  ...
  <div class="static_blocks_list-right">
    <?php if(!empty($headline)){ ?><p class="headline-h3"><?php echo $headline; ?></p><?php } ?>
    <?php if ($subtitle) : ?>
