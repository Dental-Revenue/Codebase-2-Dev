            ...
            <div class="g-box">
                <div class="g-panel g-client">
                    ...
                    <div class="g-panel-detail">
                        ...
                        <img width="60" height="22" src="<?php echo get_template_directory_uri(); ?>/assets/images/layout/g-logo.png" alt="Google Logo" class="g-logo" />
                    </div>
                </div>
                <div class="g-panel g-customer">
                    ...
                    <?php if(has_post_thumbnail()){
                        ...
                        <img width="68" height="68" style="border-radius:300%;" src="https://lh5.ggpht.com/-CFYUaGYh6Y8/AAAAAAAAAAI/AAAAAAAAAAA/MWWT48ek100/s128-c0x00000000-cc-rp-mo/photo.jpg" alt="<?php the_title(); ?>">
                        <?php } ?>
                    </div>
                    </div>
                    <div class="g-panel-detail">
