...
<div class="static_image_split">
  ...
  <div class="static_image_split-right" style="<?php if ($side_image_left_right === 'left') { echo "margin-left:50%;"; } else { echo "margin-left:0;"; } ?>">
    ...
    <a class="contact-option street-address" <?php $option = get_option('practice_info'); if (!empty($option['google_place_id'])) { echo 'href="https://www.google.com/maps/search/?api=1&query=Google&query_place_id=' . $option['google_place_id'] . '" target="_blank" rel="noopener nofollow"'; } ?>>
