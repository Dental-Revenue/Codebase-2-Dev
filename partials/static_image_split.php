...
<div class="static_image_split-img 
    <?php // Adds class based on embed type
    if ($embedtype != 'image') {
        echo 'popup-';
    } ?>
    <?php echo $embedtype ?>
    ...
    <?php //Adds URL for videos
    if ($embedtype === 'youtube' || $embedtype === 'iframe') {
        echo 'href="' . $embed . '"';
    } ?> 
    style="
    <?php // Determines side of embed
    if ($side_image_left_right === 'left') {
        echo "";
    } else {
        echo "left: 50%;";
    } ?>">
...
<div class="static_image_split-right" style="
    <?php if ($side_image_left_right === 'left') {
        echo "margin-left:50%;";
    } else {
        echo "margin-left:0;";
    } ?>">
    <div class="static_image_split-content" style="text-align:<?php echo $text_align; ?>; padding: 5% <?php echo $text_padding; ?>% 7% <?php echo $text_padding; ?>%;">
        ...
        <?php } ?>
        <?php if ($subtitle) : ?>
            <p class="sis-subtitle <?php echo $headline_style; ?>" style="text-align:<?php echo $text_align; ?>"><?php echo $subtitle; ?></p>
        <?php endif; ?>
