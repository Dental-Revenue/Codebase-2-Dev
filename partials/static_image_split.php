...
<div class="static_image_split">
  ...
  <div class="static_image_split-img <?php if ($embedtype != 'image') {
                                     ...
                                     echo $embedtype ?><?php if ($embedtype === 'custom') {
                                       echo '-' . $randomnumber;
                                     }
                                     if ($embedtype != 'image') {
  ...
  <div class="static_image_split-right" style="<?php if ($side_image_left_right === 'left') {
    ...
    <div class="static_image_split-content" style="text-align:<?php echo $text_align; ?>; padding: 5% <?php echo $text_padding; ?>% 7% <?php echo $text_padding; ?>%;">
        <?php if (!empty($headline)) {
            ?>
                  <h2 style="text-align:<?php echo $text_align; ?>" class="<?php echo $headline_style; ?>"><?php echo $headline; ?></h2><?php
        }
        ?>
        <?php if ($display_form === 'no') { ?>
            <?php if (!empty($content)) { ?>
                      <div class="static_image_split-paragraph"><?php echo $content; ?>
                      </div>
            <?php } ?>
                    ...
                    <form action="<?php echo get_form_processor(); ?>" method="post" name="form-schedule">
                        ...
                        <?php if (!empty(site_ops_recaptcha(false))) { ?>
                                  <div class="captcha-container">
                                      <div class="g-recaptcha" data-sitekey="<?php site_ops_recaptcha(); ?>">
                                      </div>
                                  </div>
                        <?php }  ?>
