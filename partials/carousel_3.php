...
<div class="row">
    ...
    if (!empty($headline)) { ?>
        <h2 class="<?php echo $headline_style; ?>"><?php echo $headline; ?></h2><?php 
    } else { ?>
...
<div class="row">
    ...
    <div class="slick-init slick-carousel_3 <?php if ($image_type == 'circle') { ?>
        slick-circle
   <?php } ?>" data-slides="<?php echo $num_slides; ?>" >    
        <?php
