...
<div class="row">
  ...
  <div class="static_photo_list-text">
    <?php if(!empty($headline)){ ?><p class="headline <?php echo $headline_style; ?>"><?php echo $headline; ?></p><?php } ?>
    <?php if ($subtitle) : ?>
  ...
  <div class="static_photo_list-left">
    <img alt="<?php if (isset($image_alt) && $image_alt!=''){ echo $image_alt; } else { echo 'Module Image'; } ?>" src="<?php echo $image[0]; ?>" />
  </div> 
  ...
  <div class="static_photo_list-right">
    ...
    $subtitle = get_post_meta(get_the_ID(), $instance.'_list_subtitle', true);
		...
		?>
    <?php if ($headline) : ?>
      <p class="headline-h3"><?php echo $headline; ?></p>
    <?php endif; ?>
    <?php if ($subtitle) : ?>
