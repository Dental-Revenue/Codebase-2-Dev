...
<div class="slick-init slick-fold_slider" style="height:<?php echo $slider_height; ?>">      
    ...
    foreach ((array) $blocks as $key => $block ) {
        ...
        <div class="fold-slide">
            <div class="fold-slide-contain" style="height:<?php echo $slider_height; ?>;
                <?php if (isset($block['bg_color'])) { ?>
                ...
                <img alt="<?php if (isset($block['alt'])) { echo $block['alt']; } else {
                ...
                <div class="fold-slide-text <?php if ($alignment != '') {
                    echo $alignment;
                } ?>"><?php if (!empty($block['subtitle'])) { ?>
                    <p style="<?php if(!wp_is_mobile()){ ?><?php echo $block['subtitle_styling']; ?><?php } else {?><?php echo $block['subtitle_styling_mobile']; ?><?php } ?>"><?php echo $block['subtitle']; ?></p><?php } ?><?php if($block['subtitle_line'] === 'Yes'){ ?><hr style="<?php echo $block['subtitle_line_style']; ?>"><?php } ?><?php if(!empty($block['title'])){ ?><p class="<?php if(!empty($block['subtitle'])&&$block['subtitle_line'] === 'No'){ ?>single_title<?php } ?>" style="<?php if(!wp_is_mobile()){ ?><?php echo $block['title_styling']; ?><?php } else {?><?php echo $block['title_styling_mobile']; ?><?php } ?>"><?php echo $block['title']; ?></p><?php } ?><?php if($block['line'] === 'Yes'){ ?><hr style="<?php echo $block['line_style']; ?>"><?php } ?><?php if(!empty($block['excerpt'])){ ?><p style="<?php if(!wp_is_mobile()){ ?><?php echo $block['excerpt_styling']; ?><?php } else {?><?php echo $block['excerpt_styling_mobile']; ?><?php } ?>" class="<?php if(!empty($block['title'])&&$block['line'] === 'No'){ ?>single_excerpt<?php } ?>"><?php echo $block['excerpt']; ?></p><?php } ?>
